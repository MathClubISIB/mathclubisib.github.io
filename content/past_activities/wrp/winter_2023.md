...
- **Primary References:**
    - _Knot Theory_ -- _Livingstone_
    - _An Interactive Introduction to Knot Theory_ -- _Inga Johnson_ and _Allison K. Heinrich_
    - _The Knot Book_ -- _Colin C. Adams_
- **Group Leader:**
    - Dhruba Sarkar (B2)
...
- **Primary References:**
    - _Random Graphs and Complex Networks Vol. 1 & 2_ -- _Remco van der Hofstad_ 
    - _Introduction to Random Graphs_ -- _Alan Frieze_ 
    - _Random Graphs_ -- _Bela Bollobas_ 
    - _The Probabilistic Method_ -- _Noga Alon_ and _Joel A. Spencer_
- **Group Leaders:**
    - Bikram Halder (B3)
    - Hrishik Koley (B2)
- **Topics to be Covered:**
    ...
    - Models of random graphs: Overview of 2 models of random graphs, namely, the \\(Erd\H{o}s-Renyi\\) model \\((G_{n,p})\\) and the Gilbert model \\((G_{n,m})\\), which are closely related.
...
- **Primary References:**
    - _Galois Theory_ -- _Ian Stewart_ 
    - _Galois Theory_ -- _Emil Artin_
    - _Algebraic Methods(Lecture Notes)_ -- _F.Oggier_
- **Group Leaders:**
...
- **Primary References:**
    - _Undergraduate Commutative Algebra_ -- _Miles Reid_
    - _Abstract Algebra_ -- _Dummit_ and _Foote_
    - _Introduction to Commutative Algebra_ -- _Atiyah_ and _MacDonald_
- **Group Leaders:**
...
We shall then study the linking properties of the result of cutting n-twisted bands, and define winding numbers to give a proof of Brower's fixed point theorem in \\(R^2\\). These will serve as the motivation for defining a key invariant called the fundamental group of a space. Using this, we will prove many results including Borzuk Ulam theorem and the Ham Sandwich theorem. We may also discuss some applications of the van Kampen theorem.

- **Primary References:**
    - _Topology Through Inquiry_ -- _Michael Starbird_ and _Francis Su_
    - _Topology_ -- _James R. Munkres_ 
    - _Algebraic Topolgy_ -- _Allen Hatcher_ 
    - _MAT327 Lecture notes, Summer 2019_
- **Group Leaders:**
    - Anasmit Pal (B2)
...
- **Primary References:**
    - _Real Analysis :Measure Theory,Integration and Hilbert Spaces_ -- _Stein_ and _Sakarchi_
    - _Measure and Integration_ -- _S.Kesavan_ 
    - _Real Analysis: Modern Techniques and Their Applications_ -- _G. Folland_ 
    - _Measure, Integration & Real Analysis_ -- _Sheldon Axler_  
- **Group Leaders:**
    - Anshuman Agrawal (B2)
    - Bhavesh Pandya (B2)
- **Topics to be Covered:**
...
- **Primary References:**
    - _Stochastic Processes_ -- _Sheldon Ross_ 
    - _Probability Theory and its applications (Vol I and Vol II)_ -- _William Feller_
    - _Analysis of Time Series_ -- _Christopher Chatfield_ 
    - _Topics in optimal transport_ -- _Cedric Villani_
- **Group Leaders:**
...
- **Primary References:**
    - _Winning Ways for Your Mathematical Plays_ -- _Elwyn R. Berlekamp_, _John H. Conway_, and _Richard K. Guy_
    - _Combinatorial Game Theory_ -- _Aaron N. Siegel_  
- **Group Leaders:**
    - Nikhil Nagaria (B2)
    - Pragalbh Kumar Awasthi (B2)
- **Topics to be Covered:**
...
- **Primary References:**
    - _Introduction to Analytic Number Theory_ -- _Tom M. Apostol_
- **Group Leaders:**
    - Aishik Sarkar (B2)
- **Topics to be Covered:**
    - Convolutions
