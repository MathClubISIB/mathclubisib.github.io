...
This is the home page of the UDGRP Summer 2022 organised by the Math Club. The projects start from Wednesday, 1 June, 2022. The topics being considered this time are presented below.
...
- **Topics Covered:**
  ...
  - The Lebesgue Integral on \\(R^d\\) and its properties.
...
- **Topics Covered:**
  ...
  - Decision Tree
  - Sampling and Model Evaluation (Stratified, Random, Cluster and Accuracy, \\(R^2\\), Precision, Recall, F1, F0.5 respectively)
